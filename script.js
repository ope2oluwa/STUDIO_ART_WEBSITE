...
function renderSiteContent() {
  document.title = `${siteData.artistName || "Artist"} — ${siteData.tagline || "Portfolio"}`;
  /* document.getElementById("headerLogo").textContent =
          siteData.artistName || "Artist";
        document.getElementById("footerLogo").textContent =
          siteData.artistName || "Artist"; */
  // Update only the text elements, not the logo images
